...
def subtest_correct_shapes(stopval):
    solver = SolverClass(stopval = stopval, lambda1=lambda1, lambda2=lambda2)
    # single vector
...
def test_bad_input():
    assert_raises(ValueError, SolverClass, stopval=-1, lambda1=lambda1, lambda2=lambda2)
    assert_raises(ValueError, SolverClass, stopval=1, lambda1=-1, lambda2=1)
    assert_raises(ValueError, SolverClass, stopval=1, lambda1=1, lambda2=-1)
